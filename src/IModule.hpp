...
public:
    ...
    virtual bool PushCommandList(const std::vector<MacroInformation>& Macros, const std::string& FileName) = 0;
    virtual bool Proccess(std::string& Data, const std::string& FileName) = 0;
    virtual bool ClearCommandList(const std::string& FileName) = 0;
};